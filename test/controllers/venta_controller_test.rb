...
class VentaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ventum" do
    assert_difference('Ventum.count') do
      post venta_url, params: { ventum: { cm: @ventum.cm, detalles: @ventum.detalles, imagen: @ventum.imagen, nombre: @ventum.nombre, precio: @ventum.precio } }
    end
  ...
  test "should update ventum" do
    patch ventum_url(@ventum), params: { ventum: { cm: @ventum.cm, detalles: @ventum.detalles, imagen: @ventum.imagen, nombre: @ventum.nombre, precio: @ventum.precio } }
