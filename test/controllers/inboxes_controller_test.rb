...
class InboxesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create inbox" do
    assert_difference('Inbox.count') do
      post inboxes_url, params: { inbox: { email: @inbox.email, message: @inbox.message, name: @inbox.name, subject: @inbox.subject } }
    end
  ...
  test "should update inbox" do
    patch inbox_url(@inbox), params: { inbox: { email: @inbox.email, message: @inbox.message, name: @inbox.name, subject: @inbox.subject } }
