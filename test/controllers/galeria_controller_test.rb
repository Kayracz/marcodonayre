...
class GaleriaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create galerium" do
    assert_difference('Galerium.count') do
      post galeria_url, params: { galerium: { cm: @galerium.cm, detalles: @galerium.detalles, imagen: @galerium.imagen, nombre: @galerium.nombre, precio: @galerium.precio } }
    end
  ...
  test "should update galerium" do
    patch galerium_url(@galerium), params: { galerium: { cm: @galerium.cm, detalles: @galerium.detalles, imagen: @galerium.imagen, nombre: @galerium.nombre, precio: @galerium.precio } }
